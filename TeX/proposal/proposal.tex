...
\subsection{Distribution of Necrosis} % (fold)
\label{sub:distribution_of_necrosis}
...
\begin{figure}[!ht]
  \caption{Static disease model in five neurons. $\alpha = 0.01, \beta = 0.5,c = 0.1,z = 0.5, \nu_1 = 0.01, \nu_2 = 0, \nu_3 = 0, \nu_4 = 0, \nu_5 = 0$ }
  \centering
